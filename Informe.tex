...
\begin{table*}[!t]
    ...
    \begin{tabularx}{\textwidth}{%
        ...
        Fuente de alimentación (adaptador 5\,V y regulador) & Alimentación del ESP32 y del servomotor & Proporciona tensión y corriente adecuadas para el funcionamiento estable del sistema. \\
        Elementos auxiliares & Protoboard o PCB, cables, resistencias, LEDs de estado, estructura mecánica del arenero & Facilitan el cableado, la señalización visual de estados y la integración física del sistema. \\
        \bottomrule
    \end{tabularx}
\end{table*}

En caso de ser necesario, se podrán añadir sensores adicionales (por ejemplo, un sensor de peso o de nivel de arena) para futuras extensiones relacionadas con el monitoreo de higiene, sin afectar el núcleo del sistema de acceso selectivo.
...
\begin{itemize}
    \item Núcleo de procesamiento con capacidad suficiente para ejecutar la lógica de detección BLE, filtrado de RSSI y control de actuadores en tiempo (casi) real.
    ...
    \item Número adecuado de pines GPIO para controlar el servomotor, leer sensores de presencia y fin de carrera, y añadir indicadores (LEDs) de estado.
\end{itemize}

Inicialmente se consideró el uso de una plataforma Arduino Mega como posible controlador adicional, debido a su número de pines y familiaridad en contextos educativos. Sin embargo, dado que el ESP32 cubre tanto las necesidades de procesamiento como de comunicación (BLE y WiFi), se opta por simplificar la arquitectura y utilizarlo como microcontrolador único. Esta decisión está alineada con los objetivos de mantener el coste bajo, reducir la complejidad del sistema y asegurar la reproducibilidad del proyecto.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Collar con beacon BLE que emite paquetes de advertising con un identificador único asociado al gato autorizado.
        ...
        \item Servomotor responsable del movimiento de la compuerta.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Controla el servomotor y lee el estado de los sensores de presencia y fin de carrera.
        \end{itemize}
    \end{itemize}
...
En el informe completo, este diagrama se representará gráficamente como una figura, enfatizando las conexiones entre el collar BLE, el ESP32, los sensores y el servomotor. La implementación seguirá una secuencia de pruebas incrementales: primero se validará la detección BLE y el filtrado por ID, luego el control del servomotor y sensores de seguridad, y finalmente la integración con la estructura física del arenero.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Gestionar el control del servomotor y la lectura de sensores de presencia y fin de carrera.
    \end{itemize}
...
A.~M. Walker, N.~N. Jonsson, A.~Waterhouse \emph{et al.}, ``Development of a novel Bluetooth Low Energy device for proximity and location monitoring in grazing sheep,'' \emph{Animal}, vol.~18, p. 101276, 2024.

\bibitem{fonseca2023wearable}
L.~Fonseca, D.~Corujo, W.~Xavier, and P.~Gonçalves, ``On the Development of a Wearable Animal Monitor,'' \emph{Animals}, vol.~13, no.~1, p. 120, 2023.

\bibitem{wild2023selective}
S.~Wild, G.~Alarc\'on-Nieto, M.~Chimento, and L.~M. Aplin, ``Manipulating actions: A selective two-option device for cognitive experiments in wild animals,'' \emph{Journal of Animal Ecology}, vol.~92, no.~8, pp. 1509--1519, 2023.

\bibitem{farine2024blebeacons}
D.~R. Farine, J.~Penndorf, S.~Bolcato, B.~Nyaguthii, and L.~M. Aplin, ``Low-cost animal tracking using Bluetooth low energy beacons on a crowd-sourced network,'' \emph{Methods in Ecology and Evolution}, vol.~15, no.~12, pp. 2247--2261, 2024.

\bibitem{gendy2023blevsrfid}
M.~E.~G. Gendy, P.~Tham, F.~Harrison, and M.~R. Yuce, ``Comparing Efficiency and Performance of IoT BLE and RFID-Based Systems for Achieving Contact Tracing to Monitor Infection Spread among Hospital and Office Staff,'' \emph{Sensors}, vol.~23, no.~3, p. 1397, 2023.

\bibitem{brian2023petfeeder}
J.~Brianbojoyou, A.~Ashivin, V.~Abilash, and V.~M. Bhaskaran, ``Automated Pet Feeder with RFID Technology using Design Thinking Approach,'' \emph{International Journal for Research in Applied Science \& Engineering Technology (IJRASET)}, vol.~11, no.~11, pp. 1090--1096, 2023.

\bibitem{zainal2023litterbox}
M.~H. Zainal and K.~L. Chua, ``Development of Automatic Litter Box Using ESP32,'' \emph{Evolution in Electrical and Electronic Engineering}, vol.~4, no.~2, pp. 529--536, 2023.

\bibitem{seema2025littertray}
M.~Seema, M.~Prince, J.~P. P.~M., and A.~Sumithra, ``An IoT-Enabled System for Monitoring and Alerting Cat Litter Tray Cleaning Based on Fill-Level Detection,'' \emph{International Journal of Environmental Sciences}, vol.~11, no.~22s, pp. 5107--5114, 2025.
